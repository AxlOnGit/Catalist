...
public partial class TestPdfFileWriter : Form
	{
		...
		// program title
		Text = "PdfFileWriter-Revision " + PdfDocument.RevisionNumber + " " + PdfDocument.RevisionDate + "-\u00a9 2013-2015 Granotech Limited";
		Trace.Write(Text);
		...
		CopyrightTextBox.Rtf =
			...
			"Copyright \u00a9 2013-2015 Granotech Limited. All rights reserved.\\par\\par \n" +
