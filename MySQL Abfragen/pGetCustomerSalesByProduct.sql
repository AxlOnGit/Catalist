CREATE DEFINER=`root`@`%` PROCEDURE `pGetCustomerSalesByProduct`(In kundennummer char(10), In artikelnummer varchar(20))
BEGIN
	Select
		a.Kundennummer,
	  k.Name1,
	...
	Where
		((a.Kundennummer = kundennummer) And (a.Vorgang = 'R' Or a.Vorgang = 'D') And (art.Artikel = artikelnummer))
	Group By
		a.Kundennummer
	Order By
		Menge DESC
