...
namespace Products.Model.Entities
{
	public class Reminder : IJob
	{
		...
		dsTasks.ReminderRow myBase = null;
		...
		/// <summary>
		/// Erzeugt eine neue Instanz der Reminder Klasse ohne Parameter (nur der Scheduler benötigt den!).
		/// </summary>
		public Reminder()
		{
			// Wir brauchen einen parameterlosen Konstrukor
			// für den Scheduler!
		}
