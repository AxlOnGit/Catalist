...
{
	public partial class pnlKontakte : pnlSlider
	{
		...
		public pnlKontakte(ContainerControl parentCtrl, Model.Entities.Kunde kunde, bool keepLoaded) : base(parentCtrl, keepLoaded)
		{
			InitializeComponent();
