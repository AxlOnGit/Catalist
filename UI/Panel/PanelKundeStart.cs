...
{
	public partial class PanelKundeStart : Panel.PanelSlider, IMetroControl
	{
		#region members
		...
		public PanelKundeStart(ContainerControl parentCtrl, Kunde kunde, bool keepLoaded) : base(parentCtrl, keepLoaded)
		{
			InitializeComponent();
